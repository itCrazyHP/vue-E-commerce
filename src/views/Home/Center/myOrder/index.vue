    ...
    <div class="order-right">
        <div class="order-content">
            ...
            <div class="orders">
                ...
                <table class="order-item" v-for="order in user.orderList.records" :key="order.id">
                    <thead>
                        <tr>
                            <th colspan="5">
                        ...
                        <tr v-for="cart, index in order.orderDetailList" :key="cart.id">
                            <td width="60%">
                                <div class="typographic">
                                    <img :src="cart.imgUrl" class=" h-[100px] w-[100px]">
                            ...
                            <template v-if="index === 0">
                                <td :rowspan="order.orderDetailList.length" width="8%" class="center">{{ order.consignee }}
                                </td>
            ...
            <div class="choose-order">
                ...
                :total="user.orderList.total"
                :continues="5"
                :totalPages="user.orderList.pages"
                @getPageNo="getPageNo"
                />
            </div>
        </div>
...
await user.getOrderList(page.value, limit.value)

const getPageNo=async(newPage:number)=>{
    page.value = `${newPage}`
    await user.getOrderList(page.value, limit.value)
} 
</script>
